...
def webui_req(U, W, M):
    ...
    if U != 'SwarmUI':
        pull(f'https://github.com/wubbleramble/segsmaker_mine {U.lower()} {W}')
    else:
    ...
    scripts = [
        f'https://github.com/wubbleramble/segsmaker_mine/raw/main/script/controlnet.py {W}/asd',
        f'https://github.com/wubbleramble/segsmaker_mine/raw/main/script/KC/segsmaker.py {W}'
    ]
    ...
    if U not in ['SwarmUI', 'ComfyUI']:
        ...
        for ass in [
            ...
            f'https://github.com/wubbleramble/segsmaker_mine/raw/main/config/NoCrypt_miku.json {W}/tmp/gradio_themes',
            f'https://github.com/wubbleramble/segsmaker_mine/raw/main/config/user.css {W} user.css'
        ]: download(ass)

        if U not in ['Forge', 'Forge-Neo']: download(f'https://github.com/wubbleramble/segsmaker_mine/raw/main/config/config.json {W} config.json')
...
def notebook_scripts():
    z = [
        (STR / '00-startup.py', f'wget -qO {STR}/00-startup.py https://github.com/wubbleramble/segsmaker_mine/raw/main/script/KC/00-startup.py'),
        (nenen, f'wget -qO {nenen} https://github.com/wubbleramble/segsmaker_mine/raw/main/script/nenen88.py'),
        (melon, f'wget -qO {melon} https://github.com/wubbleramble/segsmaker_mine/raw/main/script/melon00.py'),
        (STR / 'cupang.py', f'wget -qO {STR}/cupang.py https://github.com/wubbleramble/segsmaker_mine/raw/main/script/cupang.py'),
        (MRK, f'wget -qO {MRK} https://github.com/wubbleramble/segsmaker_mine/raw/main/script/marking.py')
    ]
...
IMG = 'https://github.com/wubbleramble/segsmaker_mine/raw/main/script/loading.png'
